...
if __name__ == '__main__':
    user_details = { 'name': 'Daniyal', 'email': 'daniyal.ai@example.com', 'phone_number': '+1234567890', 'address': 'Los Angeles' }
    summary = 'Expert AI Automation Engineer.'
    experience = [{'company': 'AI Corp', 'role': 'Lead', 'dates': '2021-Present', 'achievements': 'Applied to 1000+ jobs'}]
    projects = [{'name': 'Bot', 'description': 'LinkedIn Applier', 'technologies': 'Python'}]
    skills = ['Python', 'AI']
    certificates = [{'name': 'AI Cert', 'description': 'Advanced AI'}]
    try:
        create_resume_docx(user_details, summary, experience, projects, skills, certificates)
        print('Generated resume.docx and resume.pdf')
