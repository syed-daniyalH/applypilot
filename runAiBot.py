...
def check_target_reached():
    ...
    if easy_applied_count >= target_job_count:
        print_lg(f"\n--- SUCCESS! Target of {target_job_count} jobs reached! ---")
...
# Ask for user's target applications for this session
try:
    target_job_count = pyautogui.prompt("How many jobs would you like to apply for in this session?", "Total Applications Target", "20")
    target_job_count = int(target_job_count) if target_job_count else 20
except ValueError:
    target_job_count = 20
print_lg(f"Target set to {target_job_count} applications for this session.")
    ...
    for Question in all_questions:
        ...
        if text:
            ...
            if not prev_answer or overwrite_previous_answers:
                ...
                elif ('hear' in label or 'come across' in label) and 'this' in label and ('job' in label or 'position' in label): answer = "https://github.com/syed-daniyalH"
        ...
        try:
            while current_count < switch_number:
                ...
                for job in job_listings:
                    ...
                    if check_target_reached(): return
...
def main() -> None:
    ...
    try:
        ...
        quotes = choice([
            "Never quit. You're one step closer than before. - Daniyal",
            "All the best with your future interviews, you've got this. - Daniyal",
            "Keep up with the progress. You got this. - Daniyal",
            "If you're tired, learn to take rest but never give up. - Daniyal",
